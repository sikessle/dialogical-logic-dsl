...
\newcommand{\thema}{Entwicklung einer domänenspezifischen Sprache für die dialogische Logik}
\newcommand{\abgabedatum}{24.07.2015}
\newcommand{\zusammenfassung}{Vor dem Hintergrund einer sich wandelnden Welt versucht dieses Projekt den Bürger wieder stärker in den Mittelpunkt der Entscheidungsfindung zu rücken. Hierzu wird eine domänenspezifische Sprache entwickelt, die in Verbindung mit der dialogischen Logik eine direkte und demokratisch faire Beteiligung auf Augenhöhe ermöglicht. Dabei wird mit den Methoden der domänenspezifischen Sprachen eine Grammatik entwickelt, welche die Formulierung von dialogischen Ausdrücken in einer möglichst natürlichsprachlichen Weise ermöglicht. Ein darunterliegendes Meta-Modell bildet die Basis für die maschinelle Auswertung. Der generierte Parser und Editor unterstützen einerseits die maschinelle Erfassung und andererseits die Formulierung grammatikalisch korrekter Aussagen durch den Menschen. Potentielle Anwendungsfälle zeigen die Nützlichkeit der Entwicklung auf und weisen auf weitere Entwicklungsmöglichkeiten im Bereich der Anwendung der dialogischen Logik in Software-Tools hin.}
